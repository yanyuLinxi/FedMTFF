...
def CSharpStaticMake_task_input(batch_data, get_num_edge_types=False):
...
class CSharpStaticGraphDataset(Dataset):
    """
    ...
    def __init__(self,
        ...
        super(CSharpStaticGraphDataset, self).__init__(root, transform, pre_transform)
    ...
    def process(self):
        ...
        for raw_path in self.raw_paths:
            with gzip.open(raw_path, "r") as f:  # josnl.gz
                # raw_data = f.read()
...
if __name__ == '__main__':
    ...
    gd = CSharpStaticGraphDataset("data/lrtemp/",
